...
public class InfoViewFactory {
  ...
  public static View newInfoView(Context context, int infoViewType, @Nullable String additionalText) {
    ...
    if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNET == infoViewType) {
      ...
      infoTextView.setText(R.string.vision_card_capture_title);
      StringBuilder sb = new StringBuilder(context.getString(R.string.vision_card_capture_description));
      ...
      infoTextView.setText(R.string.vision_card_preview_title);
      StringBuilder sb = new StringBuilder(context.getString(R.string.vision_card_preview_description));
      if (additionalText != null) {
        sb.append('\n').append(additionalText);
      }
      descriptionTextView.setText(sb.toString());
